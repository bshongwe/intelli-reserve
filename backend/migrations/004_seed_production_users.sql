-- Migration: 004_seed_production_users.sql
-- Created: 2026-04-13
-- Purpose: Seed comprehensive production-ready users with proper authentication data
--
...
--
-- HOSTS (Service Providers) - Professional businesses:
-- ─────────────────────────────────────────────────────────────────────
--   Email: sarah.martinez@business.com     | Business: Martinez Business Consulting
--   Email: james.wilson@consulting.com     | Business: Wilson Executive Coaching
--   Email: aisha.patel@wellness.com        | Business: Patel Wellness & Nutrition
--   Email: marcus.robinson@coaching.com    | Business: Robinson Athletic Performance
--   Email: elena.rossi@tutoring.com        | Business: Rossi Languages & Academics
--   Email: david.kim@tech.com              | Business: Kim Tech Solutions
--   Email: jennifer.lee@creative.com       | Business: Lee Creative Studio
--   Email: robert.chen@finance.com         | Business: Chen Financial Partners
--
-- CLIENTS (Service Consumers) - Various professionals:
-- ─────────────────────────────────────────────────────────────────────
...
-- Run verification queries separately via seed_production_users_verify.sql
