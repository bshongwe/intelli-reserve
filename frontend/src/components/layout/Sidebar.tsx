  ...
  return (
    <div className="w-64 border-r bg-card p-4 flex flex-col shadow-sm">
      <div className="flex items-center gap-2.5 mb-8 px-2">
        <div className="w-8 h-8 bg-gradient-to-br from-primary to-violet-500 rounded-xl flex items-center justify-center shadow-md shadow-primary/30">
          <Zap className="w-4 h-4 text-white" strokeWidth={2.5} />
        </div>
        <h1 className="font-bold text-xl bg-gradient-to-r from-primary to-violet-500 bg-clip-text text-transparent">
          IntelliReserve
        </h1>
      </div>
